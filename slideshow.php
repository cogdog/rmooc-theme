...
<ul id="slideshow-nav"></ul>
    ...
    <div id="slideshow-posts">
        <?php while ($slideshow_query->have_posts() && $i<=5) : $slideshow_query->the_post(); $do_not_duplicate[$i] = $post->ID; ?>
    		<?php $i++; ?>
			<div class="slide">
	   ...
	   if (strlen($text) > EXCERPT_LENGTH_CHARS) :
			$text = substr($text, 0, EXCERPT_LENGTH_CHARS) . '...<div class="more-link"><a href="' . the_permalink() . '">more &raquo;&raquo;</a></div>';
	   endif;
