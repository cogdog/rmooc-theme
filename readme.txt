...
that was customized by Alan Levine (@cogdog) for the rmooc.ca site, featuring feed syndication and quick posts content, plus other visual modifications. This readme is from the original theme file.
...
This theme relies heavily on Featured Images. If your post is missing a Featured Image, the post may not appear on the homepage or on archive pages (note, the RMOOC version is modified to draw upon a pool of images via attachment IDs to use as featured images for posts thatr lack them; see `images.php`
